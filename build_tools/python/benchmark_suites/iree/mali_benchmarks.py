...
class Android_Mali_Benchmarks(object):
  ...
  MALI_VALHALL_GPU_TARGET = iree_definitions.CompileTarget(
      target_backend=iree_definitions.TargetBackend.VULKAN_SPIRV,
      target_architecture=common_definitions.DeviceArchitecture.MALI_VALHALL,
      target_abi=iree_definitions.TargetABI.LINUX_ANDROID31)
  DEFAULT_COMPILE_CONFIG = iree_definitions.CompileConfig(
      id=unique_ids.IREE_COMPILE_CONFIG_ANDROID_MALI_VALHALL_DEFAULTS,
      tags=["default-flags"],
      compile_targets=[MALI_VALHALL_GPU_TARGET])
  FUSE_PADDING_COMPILE_CONFIG = iree_definitions.CompileConfig(
      id=unique_ids.IREE_COMPILE_CONFIG_ANDROID_MALI_VALHALL_FUSE_PADDING,
  ...
  FUSE_PADDING_REPEATED_KERNEL_COMPILE_CONFIG = iree_definitions.CompileConfig(
      id=unique_ids.
      IREE_COMPILE_CONFIG_ANDROID_MALI_VALHALL_FUSE_PADDING_REPEATED_KERNEL,
