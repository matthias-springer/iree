...
// CHECK-NEXT:     %[[ARG0_CAPTURE:[a-zA-Z0-9_]+]]: !flow.dispatch.tensor<readonly:?x?xf32>, %[[ARG1_CAPTURE:[a-zA-Z0-9_]+]]: !flow.dispatch.tensor<readonly:?xf32>,
...
//  CHECK-NEXT:     (%[[ARG2:.+]]: !flow.dispatch.tensor<readonly:i32>,
//  CHECK-SAME:      %[[ARG3:.+]]: !flow.dispatch.tensor<readonly:4xi32>,
...
// CaHECK-LABEL: func.func @dynamic_slice(
//  CaHECK-SAME:   %[[ARG0:.+]]: tensor<?x?xi32>
//  CaHECK-SAME:   %[[ARG1:[a-zA-Z0-9_]+]]: tensor<i32>
//  CaHECK-SAME:   %[[ARG2:[a-zA-Z0-9_]+]]: tensor<i32>
//  CaHECK-SAME:   %[[ARG3:.+]]: index
//       CaHECK:   %[[C1:.+]] = arith.constant 1 : index
//   CaHECK-DAG:   flow.tensor.load %[[ARG1]]
//   CaHECK-DAG:   flow.tensor.load %[[ARG2]]
//   CaHECK-DAG:   %[[ARG0_D0:.+]] = tensor.dim %[[ARG0]], %c0
//   CaHECK-DAG:   %[[ARG0_D1:.+]] = tensor.dim %[[ARG0]], %c1
//       CaHECK:   %[[RESULT:.+]] = flow.dispatch.workgroups
//   CaHECK-DAG:     cmpi
//   CaHECK-DAG:     arith.select
//   CaHECK-DAG:     cmpi
//   CaHECK-DAG:     arith.select
//   CaHECK-DAG:     cmpi
//   CaHECK-DAG:     cmpi
//   CaHECK-DAG:     arith.select
//   CaHECK-DAG:     arith.select
//   CaHECK-DAG:     index_cast
//   CaHECK-DAG:     index_cast
//       CaHECK:     flow.dispatch.tensor.store
//       CaHECK:     flow.return
//       CaHECK:   return %[[RESULT]]
...
//      CaHECK: func.func @concat_pattern
// CaHECK-SAME:     %[[SRC1:.+]]: tensor<2x40xf32>
// CaHECK-SAME:     %[[SRC2:.+]]: tensor<3x40xf32>
// CaHECK-SAME:     %[[DEST:.+]]: tensor<5x40xf32>
//      CaHECK:   %[[UPDATE1:.+]] = flow.tensor.update %[[SRC1]], %[[DEST]]
//      CaHECK:   %[[UPDATE2:.+]] = flow.tensor.update %[[SRC2]], %[[UPDATE1]]
//      CaHECK:   return %[[UPDATE2]]
...
// CHECK-NEXT:     %[[ARG0_CAPTURE:[a-zA-Z0-9]+]]: !flow.dispatch.tensor<readonly:?x8xf32>
